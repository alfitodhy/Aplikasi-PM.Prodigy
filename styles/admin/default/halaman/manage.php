    ...
    <div class="panel-body">
        ...
        <form role="form" class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control title" placeholder="Nama Halaman" name="title"
...
<?php endif ?>
    ...
    $(".title").change(function () {
        $.post("<?php echo site_url("admin/halaman/permalink") ?>", {permalink: $(this).val()}, function (res) {
            $(".permalink").val(res);
        });
    });
</script>
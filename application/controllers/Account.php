...
class Account extends CIF_Controller {
    ...
    public function register() {
        ...
        $this->form_validation->set_message('is_unique', 'email sudah terdaftar'. "<a href=\"javascript:popup_switch('forgot')\">" . ", " .'klik disini' ."</a>" . " " .lang('global_to_reset_your_password'));
    ...
    public function check_login() {
        $this->form_validation->set_message('check_login', 'Terdapat kesalahan saat login, pastikan username dan password anda benar');
